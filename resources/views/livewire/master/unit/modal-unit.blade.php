       ...
       <div class="modal-dialog modal-md" role="document">
           <div class="modal-content">
               <div class="modal-header">
                   <h5 class="modal-title">Data Bagian</h5>
               ...
               <div class="modal-body">
                   <div class="form-group mb-0 row">
                       <label class="form-label col-3 col-form-label">Nama Bagian</label>
                       <div class="col">
                           <input wire:model="namaBagian" type="text" class="form-control form-control-sm" placeholder="Nama Bagian">
                           @if($errors->has('namaBagian'))
                               <p style="color:red;">{{ $errors->first('namaBagian') }}</p>
                           @endif
                       </div>
                   </div>
                   @if($modeUpdate === true) 
